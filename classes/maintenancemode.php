...
class MaintenanceMode {
	...
	public function mm_effective_notice() {
		...
		echo '<div class="error"><p><strong>' . __( 'Maintenance Mode Enabled:', 'maintenancemode' ) . '</strong> ' . __( 'Site will be read-only while migration takes place.', 'maintenancemode' ) . '</p></div>';
